...
> 类型：06-reference 历史资料 | 说明：Agent 转型路线图（规划文档，部分已落地），内容已分解进 01-architecture/agent-orchestration.md
...
本路线图与 [Agent转型-实施计划.md](./agent-transformation-plan.md) 配套使用：
...
> **设计依据**：详细的记忆系统设计方案参见 [记忆系统-设计方案.md](../01-architecture/memory-system.md)。本章仅概述架构和集成方式，不重复完整设计细节。
...
| **PROJECT**（项目记忆） | 案件、咨询事项 | "2026-07-10 用户咨询了劳动纠纷赔偿问题" | 30 天 |
